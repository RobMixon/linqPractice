...
namespace linq {
    class Program {
        static void Main (string [] args) {
            ...
            List<int> wheresSqaredo = new List<int> () {
                66,
                12,
                8,
                27,
            ...
            List<int> perfectSquares = wheresSqaredo.Where (n => {
            ...
            List<MillionairesByBank> MillionaresReport = (
            ...
            foreach (MillionairesByBank entry in MillionaresReport) {
